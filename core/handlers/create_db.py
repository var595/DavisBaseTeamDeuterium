        ...
        return [
            {
                ...
                "column_name_list": ["rowid", "table_name", "page_size", "id_row"],
                "table_name": "system_tables",
                "value_list": [1, "system_tables", ConfigManager.get_page_size(), 2],
            },
            {
                "command": "INSERT INTO TABLE",
                "column_name_list": ["rowid", "table_name", "page_size", "id_row"],
                "table_name": "system_tables",
                "value_list": [2, "system_columns", ConfigManager.get_page_size(), 11],
            },
        ]
        ...
        return [
            {
                ...
                "table_name": "system_columns",
                "value_list": [1, "system_tables", "rowid", "INT", 1, "NO", "UNI"],
            },
            {
                "command": "INSERT INTO TABLE",
                "column_name_list": [
            ...
            },
            {
                ...
                "table_name": "system_columns",
                "value_list": [4, "system_tables", "id_row", "INT", 4, "NO", ""],
            },
            {
                "command": "INSERT INTO TABLE",
                "column_name_list": [
                ...
                "table_name": "system_columns",
                "value_list": [5, "system_columns", "rowid", "INT", 1, "NO", "UNI"],
            },
            {
                "command": "INSERT INTO TABLE",
                "column_name_list": [
                ...
                "table_name": "system_columns",
                "value_list": [6, "system_columns", "table_name", "TEXT", 2, "NO", ""],
            },
            {
                "command": "INSERT INTO TABLE",
                "column_name_list": [
                ...
                "table_name": "system_columns",
                "value_list": [7, "system_columns", "column_name", "TEXT", 3, "NO", ""],
            },
            {
                "command": "INSERT INTO TABLE",
                "column_name_list": [
                ...
                "table_name": "system_columns",
                "value_list": [8, "system_columns", "data_type", "TEXT", 4, "NO", ""],
            },
            {
                "command": "INSERT INTO TABLE",
                "column_name_list": [
